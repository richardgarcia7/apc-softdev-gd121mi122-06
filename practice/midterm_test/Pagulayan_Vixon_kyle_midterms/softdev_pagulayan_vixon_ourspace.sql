...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2015 at 06:45 AM
...
--
-- Database: `softdev_pagulayan_vixon_ourspace`
--
...
ALTER TABLE `mycomment`
  ADD PRIMARY KEY (`id`), ADD KEY `mycomment_ibfk` (`myaddress_id`);
...
--
ALTER TABLE `mycomment`
ADD CONSTRAINT `mycomment_ibfk` FOREIGN KEY (`myaddress_id`) REFERENCES `myaddress` (`id`);
