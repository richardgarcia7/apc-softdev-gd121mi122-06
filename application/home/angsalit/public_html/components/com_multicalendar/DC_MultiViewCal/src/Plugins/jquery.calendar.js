...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function render() {
            ...
            switch (option.view) {
                ...
                case "nDays":
                    ...
                    break;
                case "list":
                    BuildListView(showday, option.numberOfDaysList, events, config);
        ...
        function BuildListView(startday, l, events, config) {
            ...
            {
                if ( (option.vstart<=events[i][2] && option.vend>=events[i][2])
                  || (option.vstart<=events[i][3] && option.vend>=events[i][3])
                  || (option.vstart>=events[i][2] && option.vend<=events[i][3])  
                )
                {
                    ...
                    str += '<div><div class="list_event_content" style="border-left:3px solid '+((events[i][7]!=-1 && events[i][7]!=null)?events[i][7]:"#"+option.paletteDefault)+';">' + d + "<div>"+events[i][1]+"</div>"+((events[i][9]!="" && events[i][9]!=null)?"<div>"+events[i][9]+"</div>":"")+((events[i][11]!="" && events[i][11]!="<br />" && events[i][11]!=null)?"<div>"+events[i][11]+"</div>":"") + "</div></div>";
                }
            ...
            pv: function() {
                switch (option.view) {
                    ...
                    case "nDays":
                        ...
                        break;
                    case "list":
                        option.showday = DateAdd("d",(-1 * option.numberOfDaysList), option.showday);
                        break;    
                    case "month":
                    case "nMonth":
            ...
            nt: function() {
                switch (option.view) {
                    ...
                    case "nDays":
                        ...
                        break;
                    case "list":
                        option.showday = DateAdd("d", option.numberOfDaysList, option.showday);
                        break;
                    case "month":
                    case "nMonth":
