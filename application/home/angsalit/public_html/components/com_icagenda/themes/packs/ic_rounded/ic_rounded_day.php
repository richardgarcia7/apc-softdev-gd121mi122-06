	...
	<div class="icevent <?php echo $multi_events; ?>" style="background:<?php echo $bg_day; ?> !important; z-index:1000;">
		...
		<span class="spanEv">
			...
			<?php foreach($events as $e){
				...
				// Show image if exist
				if ($e['image']) {
					echo '<a href="'.$e['url'].'"><div class="linkTo"><span style="background: '.$e['cat_color'].';" class="img"><img src="'.$e['image'].'" alt="" /></span>';
				}
				else {
				...
				echo '<span><div class="titletip">&rsaquo; '.$e['title'].'</div>';
