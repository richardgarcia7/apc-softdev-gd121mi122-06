...
class iCicons {
	...
	public static function showIcon($type, $link = '', $vcal = '', $gcal = '', $wcal = '', $ycal = '') {
		...
		switch ( strtolower($type) ) {
			case 'printpreview':
				$html[]= '<a class="icTip" href="' . $link . '" onclick="window.open(this.href,\'win2\',\'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no\'); return false;" title="' . JText::_('JGLOBAL_PRINT') . '">';

				if(version_compare(JVERSION, '3.0', 'lt')) {

					$html[]= JHtml::_('image', 'system/printButton.png', JText::_('JGLOBAL_PRINT'), null, true);
//					$html[]= '&#160;' . JText::_('JGLOBAL_PRINT') . '&#160;';

				} else {

					$html[]= '<span class="iCicon-print"></span>';
//					$html[]= '&#160;' . JText::_('JGLOBAL_PRINT') . '&#160;';
...
//				$html[]= JHTML::_('image', 'components/com_icagenda/themes/packs/default/images/print-preview.png', JText::_( 'JGLOBAL_PRINT' ), array('title'=>JText::_( 'COM_ICAGENDA_PRINT_LABEL' ), 'class'=>'hidden-phone')).'</a>';
				break;

			case 'print':
				$html[]= '<a href="#" onclick="window.print();return false;" title="' . JText::_('JGLOBAL_PRINT') . '">';
				...
				if(version_compare(JVERSION, '3.0', 'lt')) {
					...
					$html[]= '<span class="iCicon-print"></span>&#160;' . JText::_('JGLOBAL_PRINT') . '&#160;';

				}

				$html[]= '</a>';

//				$html[]= JHTML::_('image', 'components/com_icagenda/themes/packs/default/images/print-icon.png', JText::_( 'JGLOBAL_PRINT' ), array()).'</a>';
				break;
			...
			case 'vcal':
				...
				if (in_array('1', $iconAddToCal_options)) {
					...
					$addtocal.= '<a href="' . $gcal . '" class="ic-title-cal-tip">';
				...
				if (in_array('2', $iconAddToCal_options)) {
					$addtocal.= '<div class="ic-tip-link">';
					$addtocal.= '<a href="' . $vcal . '" class="ic-title-cal-tip">';
				...
				if (in_array('4', $iconAddToCal_options)) {
					$addtocal.= '<div class="ic-tip-link">';
					$addtocal.= '<a href="' . $wcal . '" class="ic-title-cal-tip">';
				...
				if (in_array('5', $iconAddToCal_options)) {
					$addtocal.= '<div class="ic-tip-link">';
					$addtocal.= '<a href="' . $ycal . '" class="ic-title-cal-tip">';
				...
				$html[]= '<a class="ic-addtocal" href="#" title="'.$return_atc.'">';
//				$html[]= '<a class="icTip" href="' . $link . '" title="' . JText::_( 'COM_ICAGENDA_ADD_TO_CALL_LABEL' ) . '">';

				if(version_compare(JVERSION, '3.0', 'lt')) {

					$html[]= JHtml::_('image', 'system/calendar.png', JText::_('COM_ICAGENDA_ADD_TO_CALL_LABEL'), null, true);
//					$html[]= '&#160;' . JText::_('COM_ICAGENDA_ADD_TO_CALL_LABEL') . '&#160;';

				} else {

					$html[]= '<span class="iCicon-calendar"></span>';
//					$html[]= '&#160;' . JText::_('COM_ICAGENDA_ADD_TO_CALL_LABEL') . '&#160;';
...
//				$html[]= JHTML::_('image', 'components/com_icagenda/themes/packs/default/images/calendar-timeline.png', JText::_( 'COM_ICAGENDA_VCAL_ICAL_LABEL' ), array('title'=>JText::_( 'COM_ICAGENDA_VCAL_ICAL_LABEL' ))).'</a>';
				break;
				}
