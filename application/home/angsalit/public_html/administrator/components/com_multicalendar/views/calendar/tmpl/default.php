	...
	<table class="admintable">
		...
		<tr>
			<td width="110" class="key" valign="top">
				<label for="title">
					<?php echo JText::_( 'Use list box' ); ?>:
				</label>
			</td>
			<td>
				<div class="width-30 fltlft">
				    <?php echo JText::_('Subject list'); ?><br />Comma separated list (with no spaces or returns)<br /> Leave blank if you don't  want to use list<br /><textarea style="width:95%;height:100px" name="subjectlist" id="subjectlist"><?php echo $this->calendar->subjectlist; ?></textarea>
                </div>
                <div class="width-30 fltlft">
                    <?php echo JText::_('Location list'); ?><br />Comma separated list (with no spaces or returns)<br /> Leave blank if you don't  want to use list<br /><textarea style="width:95%;height:100px" name="locationlist" id="locationlist"><?php echo $this->calendar->locationlist; ?></textarea>
                </div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php echo "<div>".JHTML::_('select.genericlist',   $this->users, "owner", '', 'value', 'text', $this->calendar->owner )."</div>";?>
			</td>
		</tr>
		<tr>
