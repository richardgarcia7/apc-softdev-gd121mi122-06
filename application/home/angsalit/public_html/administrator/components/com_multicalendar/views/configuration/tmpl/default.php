...
//////////////////////////// tab1 /////////////////////////////////////////				
			...
			$("#additional_parameters").val(tab1.additional_parameters);
			showhide("sample");
//////////////////////////// tab3 /////////////////////////////////////////
            $("#tabs-3Form").validate({
			    //ignore: "",
                submitHandler: function(form) {
                    if ($.post("index.php?option=com_multicalendar&view=configuration&task=ajax&tab=3", $("#tabs-3Form").serialize()))
                        alert('Configuration successfully updated!');
                }
            });
            $("#subjectlist").val(tab1.subjectlist);
            $("#locationlist").val(tab1.locationlist);
//////////////////////////// tab2 /////////////////////////////////////////
...
.field{float:left;margin-left:20px;margin-top:10px;}
    ...
    <div id="tabs">
			<ul>
				...
				<li><a href="#tabs-3"><?php echo JText::_( 'Use list box' )?></a></li>
			</ul>
			<div id="tabs-1">
			<form action="index.php" method="post" name="tabs-1Form" id="tabs-1Form">
			    ...
			    <div class="field">
				    ...
				    <input id="views4" name="views[]" class="views" value="viewList" checked="checked" type="checkbox" class="required"> <?php echo JText::_( 'List' )?><br />
			    </div>
			    ...
			    <div class="field"><select id="viewdefault" name="viewdefault"> 
                    	...
                    	<option value="list"><?php echo JText::_( 'List' )?></option>
                    </select></div>
			    ...
			    <label><?php echo JText::_( 'Additional parameters' )?></label>
			    <div class="field"><textarea name="additional_parameters" id="additional_parameters" style="width:100%;height:100px"></textarea></div>
			    <div style="clear:both"></div>
			...
			<form action="index.php" method="post" name="tabs-3Form" id="tabs-3Form">    
				<table>
				    <tr>
				        <td><b>Subject list</b><br />Comma separated list (with no spaces or returns)<br /> Leave blank if you don't  want to use list<br />
				        <textarea style="width:95%;height:100px" name="subjectlist" id="subjectlist"><?php echo $this->calendar->subjectlist; ?></textarea>
				        </td>
				    </tr>
				    <tr>    
				        <td><b>Location list</b><br />Comma separated list (with no spaces or returns)<br /> Leave blank if you don't  want to use list<br />
				        <textarea style="width:95%;height:100px" name="locationlist" id="locationlist"><?php echo $this->calendar->locationlist; ?></textarea>
				        </td>
				    </tr>
				</table>
				<input type="submit" class="sbtn submit" id="btnSave" value="<?php echo JText::_( 'SAVE' )?>"/>
